export const PrivacyPage = () => {
  return (
    <div className="flex flex-col gap-6 w-full  dark:prose-invert dark">
      ...
      <ul className="ml-6">
        <li>
          <strong>Kontaktní údaje</strong>: Když vytvoříte účet, požádáme Vás o
          poskytnutí e-mailové adresy a jména Vaší společnosti.
        </li>
        <li>
      ...
      <ul className="ml-6">
        ...
        <li>
          Odesílání informací, které mohou být pro Vás užitečné, včetně nabídek
          a aktualizací.
        </li>
      ...
      <ul className="ml-6">
        ...
        <li>
          S poskytovateli služeb, kteří nám pomáhají poskytovat Aplikaci (např.
          hosting, technická podpora), vždy pod přísnými smluvními podmínkami o
          ochraně údajů.
        </li>
      ...
      <h2>4. Vaše práva</h2>
      <p>
        Máte právo na přístup, opravu nebo vymazání Vašich osobních údajů, které
        máme. Můžete také nesouhlasit s určitými způsoby používání Vašich
        informací.
      </p>
